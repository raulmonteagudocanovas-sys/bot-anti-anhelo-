...
<table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
  ...
  <tr><td style="background-color:#0d0d0d;padding:30px 40px 20px 40px;text-align:center;">
    <p style="margin:0;color:#C9A84C;font-size:11px;letter-spacing:3px;text-transform:uppercase;">RA&Uacute;L M. C&Aacute;NOVAS &middot; M&Eacute;TODO CAUSA &amp; EFECTO</p>
  ...
  <tr><td style="background-color:#0d0d0d;padding:30px 40px 10px 40px;text-align:center;">
    <p style="margin:0;color:#888;font-size:13px;letter-spacing:1px;">Tu diagn&oacute;stico ha sido procesado.</p>
  ...
  <tr><td style="background-color:#111;padding:30px 40px;text-align:center;">
    ...
    <p style="margin:16px 0 0 0;color:#f5f4f0;font-size:20px;font-weight:bold;line-height:1.5;">Si dentro de un a&ntilde;o sigues igual,<br>&iquest;qu&eacute; habr&aacute; decidido por ti?</p>
    <p style="margin:16px 0 0 0;color:#aaa;font-size:14px;line-height:1.8;">El diagn&oacute;stico que acabas de recibir no es un an&aacute;lisis. Es un espejo. Lo que viste ah&iacute; lleva tiempo funcionando en silencio, gobernando tus decisiones sin que t&uacute; lo eligieras.</p>
    <p style="margin:16px 0 0 0;color:#f5f4f0;font-size:15px;line-height:1.8;font-style:italic;">El problema nunca fue la falta de informaci&oacute;n. Fue la ausencia de un sistema que funcione incluso cuando no tienes ganas.</p>
  </td></tr>
  ...
  <tr><td style="background-color:#111;padding:30px 40px;text-align:center;">
    ...
    <p style="margin:16px 0 0 0;color:#f5f4f0;font-size:20px;font-weight:bold;line-height:1.5;">El m&eacute;todo completo est&aacute; en el libro.</p>
    <p style="margin:16px 0 0 0;color:#aaa;font-size:14px;line-height:1.8;">No es autoayuda gen&eacute;rica. No es motivaci&oacute;n que dura tres d&iacute;as. Es un sistema de 27 pasos organizado en 8 bloques que trabajan exactamente los patrones que tu diagn&oacute;stico ha identificado. Cada cap&iacute;tulo es una herramienta concreta.</p>
    <table width="100%" cellpadding="0" cellspacing="0" style="margin:20px 0;">
      <tr><td style="padding:8px 0;color:#f5f4f0;font-size:14px;text-align:left;"><span style="color:#C9A84C;font-weight:bold;">&#10003;</span>&nbsp;&nbsp;Recupera tu paz mental sin depender de la motivaci&oacute;n</td></tr>
      ...
      <tr><td style="padding:8px 0;color:#f5f4f0;font-size:14px;text-align:left;"><span style="color:#C9A84C;font-weight:bold;">&#10003;</span>&nbsp;&nbsp;Rompe el ciclo de intento y reca&iacute;da de una vez por todas</td></tr>
      <tr><td style="padding:8px 0;color:#f5f4f0;font-size:14px;text-align:left;"><span style="color:#C9A84C;font-weight:bold;">&#10003;</span>&nbsp;&nbsp;Construye la versi&oacute;n de ti que llevas a&ntilde;os aplazando</td></tr>
    </table>
  </td></tr>
  ...
  <tr><td style="background-color:#0d0d0d;padding:30px 40px 20px 40px;text-align:center;">
    <p style="margin:0 0 20px 0;color:#f5f4f0;font-size:16px;font-weight:bold;">El mapa ya lo tienes. El camino empieza aqu&iacute;.</p>
    <a href="https://www.amazon.es/dp/B0H5FS71XT" target="_blank" style="display:inline-block;background-color:#C9A84C;color:#0d0d0d;font-size:16px;font-weight:bold;text-decoration:none;padding:18px 40px;border-radius:3px;letter-spacing:1px;text-transform:uppercase;">REG&Aacute;LATE EL CAMBIO</a>
    <p style="margin:12px 0 0 0;color:#666;font-size:12px;">CAUSA &amp; EFECTO &middot; Disponible en Amazon (eBook y tapa blanda)</p>
  </td></tr>
  ...
  <tr><td style="background-color:#0d0d0d;padding:20px 40px;text-align:center;">
    ...
    const emailRes = await fetch("https://api.brevo.com/v3/smtp/email", {
      ...
      body: JSON.stringify({
        ...
        subject: `${nombreDisplay}, lo que viste en tu diagn\u00f3stico es solo la superficie.`,
